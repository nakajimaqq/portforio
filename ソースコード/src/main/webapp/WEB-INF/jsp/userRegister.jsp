...
<%-- ページのタイトルを設定する --%>
<%
pageContext.setAttribute("title", "アカウントの登録", PageContext.PAGE_SCOPE);
%>
		...
		<div class="container-md mt-5">
			...
			<div class="row mt-2 mb-5 justify-content-center">
				...
				<div class="col-md-5">
					...
					class="form-control 
					<c:if test="${errors.password != null }">is-invalid</c:if>" >
					<div class="invalid-feedback">${errors.password}</div>
				</div>
			</div>
			<div class="row mt-5 justify-content-center">
				<a href="${root_path}/Login" class="col-auto link-secondary mt-5">キャンセル</a>
			</div>
		</div>
