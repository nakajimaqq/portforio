...
<%-- ページのタイトルを設定する --%>
<%
pageContext.setAttribute("title", "削除の確認", PageContext.PAGE_SCOPE);
%>
		...
		<div class="row my-5 ">
			...
			<div class="row mt-5 justify-content-center">
				...
				<p class="text-center  mt-4">
					<small class="bg-light">&#042;書籍データの削除の場合、<br>書籍タイトル&middot;感想などが全て削除されますがよろしいですか&#063;
					</small>
				</p>
				<div class="row mt-3 justify-content-center">
					<div class="col-auto">
						<a href="${root_path}/Individual?book_id=${book.id}" role="button"
